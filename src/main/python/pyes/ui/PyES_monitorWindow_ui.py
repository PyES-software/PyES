...
class Ui_MonitorWindow(object):
    ...
    def retranslateUi(self, MonitorWindow):
        MonitorWindow.setWindowTitle(
            QCoreApplication.translate("MonitorWindow", "Result Monitor", None)
        )
        self.status.setText(
            QCoreApplication.translate("MonitorWindow", "Waiting", None)
        )
        self.status_label.setText(
            QCoreApplication.translate(
                "MonitorWindow",
                '<html><head/><body><p><span style=" font-weight:700;">Status:</span></p></body></html>',
                None,
            )
        )
        self.label.setText(
            QCoreApplication.translate(
                "MonitorWindow",
                '<html><head/><body><p><span style=" font-weight:700;">Results:</span></p></body></html>',
                None,
            )
        )
