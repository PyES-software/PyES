...
class Ui_inputTitrationOpt(object):
    def setupUi(self, inputTitrationOpt):
        ...
        self.rangesScrollArea = QScrollArea(inputTitrationOpt)
        self.rangesScrollArea.setObjectName(u"rangesScrollArea")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Maximum)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.rangesScrollArea.sizePolicy().hasHeightForWidth())
        self.rangesScrollArea.setSizePolicy(sizePolicy2)
        self.rangesScrollArea.setWidgetResizable(True)
        ...
        self.rangesScrollArea.setWidget(self.rangesScrollAreaWidgetContents)

        self.formLayout.setWidget(4, QFormLayout.SpanningRole, self.rangesScrollArea)
