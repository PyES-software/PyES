...
class Ui_ExportWindow(object):
    def setupUi(self, ExportWindow):
        ...
        self.formLayout.setWidget(6, QFormLayout.LabelRole, self.optimized_check_excel)
        ...
        self.formLayout_2.setWidget(5, QFormLayout.LabelRole, self.errors_check_csv)

        self.optimized_check_csv = QCheckBox(self.widget_5)
        self.optimized_check_csv.setObjectName(u"optimized_check_csv")

        self.formLayout_2.setWidget(7, QFormLayout.LabelRole, self.optimized_check_csv)
